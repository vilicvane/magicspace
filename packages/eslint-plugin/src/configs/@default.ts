export const defaultConfig = {
  ...
  plugins: ['@magicspace', '@typescript-eslint', 'import', 'no-null'],
  rules: {
    '@magicspace/empty-line-around-blocks': 'warn',
    ...
    '@magicspace/import-path-be-smart': 'warn',
    '@magicspace/import-path-no-parent': 'warn',
    '@magicspace/import-path-shallowest': 'off',
    '@magicspace/import-path-strict-hierarchy': 'off',
    '@magicspace/no-empty-constructor': 'warn',
    ...
    '@magicspace/scoped-modules': 'warn',
